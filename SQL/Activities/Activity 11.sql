...
SELECT s.salesman_id, s.salesman_name, o.order_no, 'highest on', o.order_date, o.purchase_amount 
FROM salesman s, orders o
WHERE s.salesman_id=o.salesman_id
AND o.purchase_amount=(SELECT MAX(purchase_amount) 
FROM orders c WHERE c.order_date = o.order_date)
UNION
SELECT s.salesman_id, s.salesman_name, o.order_no, 'lowest on', o.order_date, o.purchase_amount
FROM salesman s, orders o
WHERE s.salesman_id=o.salesman_id
